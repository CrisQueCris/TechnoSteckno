...
def ScrapeLast10weeks():
    ...
    last10weeks = [date.fromisocalendar(iso_date.year, iso_date.week-i, 6) for i in range(1,11)]
    ...
    for weeklychart in last10sat:
        ...
        BillboardTop100df.to_csv('billboard/billboardTop100' + weeklychart +'.csv')
        print('Saved billboardTop100' + weeklychart +'.csv sucessfully')    
    return
